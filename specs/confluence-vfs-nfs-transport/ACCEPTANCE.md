...
| Metadata/body consistency and external/negative visibility | Slice 39 direct-read TTL fix and real-kernel post-TTL test; Slices 43–44 historic timestamps/cache migration | Mutable generated-view attribute coherence (e.g. comments changing without page version); broader live visibility timing |
