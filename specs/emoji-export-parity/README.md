...
P0 and P1 are complete. Typed emoji resolution, the native Cloud picker
corpus, semantic callout accessibility, rendered goldens, live Cloud exports,
and the Body Storage/Data Center compatibility contract are all proved.
