  ...
  properties: {
    ...
    workflow: {
      ...
      properties: {
        ...
        event: { const: "push" },
        branch: { const: "main" },
        runId: { anyOf: [{ type: "integer", minimum: 1 }, { type: "null" }] },
        runAttempt: { anyOf: [{ type: "integer", minimum: 1 }, { type: "null" }] },
        status: { enum: ["missing", "queued", "in_progress", "completed"] },
        conclusion: { anyOf: [{ type: "string", minLength: 1 }, { type: "null" }] },
        url: { anyOf: [{ type: "string", pattern: "^https://github\\.com/" }, { type: "null" }] },
      },
    },
    requiredJob: {
      type: "object",
