...
import * as importPdf from "@atlcli/import-pdf";
import * as importPdfNode from "@atlcli/import-pdf/node";
...
import * as exportWiring from "@atlcli/export-wiring";
import * as templatePack from "@atlcli/template-pack";
import * as exportNode from "@atlcli/export-node";

for (const [name, mod] of Object.entries({ pluginApi, core, importCore, importPdf, importPdfNode, diagram, confluence, docx, pdf, pcb, exportMacros, exportWiring, templatePack, exportNode })) {
