...
/**
 * Live-Confluence E2E harness for `--format pdf` (spec 008 Tests). GATED behind
 * `ATLCLI_E2E=1` so `bun test` stays offline by default — the orchestrator runs
 * these against profile `mayflower` / space `DOCSY` per CLAUDE.md and cleans up
 * any pages it creates.
 *
